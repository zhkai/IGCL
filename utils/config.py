...
class RAEEnsembleConfig:
    def __init__(self, dataset, x_dim, h_dim, preprocessing, use_overlapping, rolling_size, epochs, milestone_epochs,
                 lr, gamma, batch_size, weight_decay, early_stopping, loss_function, rnn_layers, use_clip_norm,
                 gradient_clip_norm,
                 use_bidirection, force_teaching, force_teaching_threshold, display_epoch, save_output, save_figure,
...
class odeConfig(object):
    def __init__(self, buildA_true, num_nodes, device, subgraph_size, node_dim, dilation_exponential,
                 tanhalpha, solver_1, time_1, step_1, solver_2, time_2, step_2, alpha, rtol, atol, adjoint, perturb,
                 dataset, in_dim, h_dim, preprocessing, use_overlapping, rolling_size, epochs, milestone_epochs,
                 lr, gamma, batch_size, weight_decay, early_stopping, loss_function, display_epoch, save_output,
                 save_figure, save_model, load_model, continue_training, dropout, use_spot, use_last_point, save_config,
                 load_config, server_run, robustness, pid, save_results):
...
class GWNConfig(object):
    def __init__(self, dataset, in_dim, h_dim, out_dim, adjdata, adjtype, gcn_bool, num_nodes, addaptadj, device,
                 preprocessing, use_overlapping, rolling_size, epochs, milestone_epochs,
                 lr, gamma, batch_size, weight_decay, early_stopping, loss_function, display_epoch, save_output,
                 save_figure, save_model, load_model, continue_training, dropout, use_spot, use_last_point, save_config,
                 load_config, server_run, robustness, pid, save_results):
